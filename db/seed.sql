...
INSERT INTO ride_service_tiers (id, name, capacity, base_fare, per_mile, per_minute, minimum_fare, booking_fee, cancellation_fee) VALUES
  ('tier_go', 'Sazilo Go', 4, 2.50, 1.35, 0.32, 6.50, 1.25, 4.00),
  ('tier_plus', 'Sazilo Plus', 6, 4.50, 1.90, 0.45, 9.00, 1.75, 5.00),
  ('tier_exec', 'Sazilo Exec', 4, 8.00, 3.10, 0.72, 18.00, 2.50, 8.00);
...
INSERT INTO marketplace_businesses (
  ...
  (
    'biz_003', 'Sazilo-grocery-irving', 'Sazilo Grocery Irving', NULL, 'groceries',
    'city_dal', 'zone_irving', 'Irving', '3317 Belt Line Rd, Irving, TX', 32.856800, -96.996400,
    '+1-972-555-0110', 'https://example.com/Sazilo-grocery',
  ...
  (
    'biz_006', 'dfw-Sazilo-rides', 'DFW Sazilo Rides', NULL, 'rides',
    'city_dal', 'zone_dfw_airport', 'DFW Airport', '2400 Aviation Dr, DFW Airport, TX', 32.899800, -97.040300,
    '+1-972-555-0112', 'https://example.com/dfw-Sazilo-rides',
  ...
  (
    'biz_009', 'Sazilo-event-photo-chicago', 'Sazilo Event Photo Chicago', NULL, 'photography',
    'city_chi', 'zone_north', 'North Side', '2550 W Devon Ave, Chicago, IL', 41.997200, -87.691100,
    '+1-312-555-0131', 'https://example.com/Sazilo-event-photo',
  ...
  (
    'biz_010', 'Sazilo-social-sewa-desk-chicago', 'Sazilo Social Sewa Desk', NULL, 'social_sewa',
    'city_chi', 'zone_loop', 'Downtown Loop', 'Community volunteer desk, Chicago, IL', 41.881900, -87.629100,
    '+1-312-555-0132', 'https://example.com/Sazilo-social-sewa',
  ...
  (
    'biz_019', 'Sazilo-potluck-event-planning-chicago', 'Sazilo Potluck Event Planning', NULL, 'events',
    'city_chi', 'zone_north', 'North Side', 'Chicago community potluck board', 41.938900, -87.654400,
    '+1-312-555-0149', 'https://example.com/Sazilo-potluck-planning',
  ...
  (
    'biz_022', 'Sazilo-community-matchmaking-threads', 'Sazilo Community Matchmaking Threads', NULL, 'matchmaking',
    'city_nyc', 'zone_queens', 'Jackson Heights', 'Member-moderated adult introduction board', 40.752400, -73.888800,
    '+1-718-555-0152', 'https://example.com/Sazilo-matchmaking',
  ...
  (
    'biz_023', 'Sazilo-volunteer-opportunities-chicago', 'Sazilo Volunteer Opportunities', NULL, 'volunteering',
    'city_chi', 'zone_loop', 'Downtown Loop', 'Chicago community volunteer board', 41.883600, -87.632400,
    '+1-312-555-0153', 'https://example.com/Sazilo-volunteer-opportunities',
